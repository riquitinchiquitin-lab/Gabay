...
- **Memory Master**: Sharpen your recall with a card-matching game featuring your saved words and regional vocabulary.
- **Roleplay**: Engage in simulated conversations to practice Tagalog in real-world contexts.
...
To set up **Gabay** on your local machine or server, please follow the comprehensive guide in [INSTALL.md](./INSTALL.md).
...
This project is licensed under the **Creative Commons Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)**. See the [LICENSE.md](LICENSE.md) file for details.

---

## 🛡️ Security

We take security seriously. Please review our [SECURITY.md](SECURITY.md) for reporting vulnerabilities and understanding our security posture.
